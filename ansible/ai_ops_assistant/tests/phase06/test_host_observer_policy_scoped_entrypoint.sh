...
grep -Fq 'ai_ops_assistant_host_observer_boundary_audit_pair:' "$playbook"
grep -Fq 'ai_ops_assistant_host_observer_boundary_pre_attestation:' "$playbook"
grep -Fq 'ai_ops_assistant_host_observer_boundary_post_attestation:' "$playbook"
grep -Fq 'ai_ops_assistant_host_observer_boundary_rollback:' "$playbook"
grep -Fq 'final_acceptance: false' "$playbook"
